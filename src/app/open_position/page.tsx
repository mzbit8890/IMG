...
const OpenPage = () => {
  ...
  return (
    ...
    <>
     <Wrapper>
     <div>
     <h2 className='sm:text-5xl/tight text-[28px] about8:text-4xl/tight mt-10 font-bold text-gray-800 text-center gap-3'>Job Listin<span className='text-blue-600'>gs</span>
...
<Select>
  <SelectTrigger className="w-[280px] focus-visible:ring-0 focus-visible:ring-transparent h-[60px] rounded-full shadow-md shadow-gray-400 border mt-8 about8:mt-14   about8:px-5 py-2 about8:py-5">
...
<SelectItem value="VisualCommunicationServices">Visual Communication Services</SelectItem>
  ...
  <Select>
  <SelectTrigger className="w-[280px] focus-visible:ring-0 focus-visible:ring-transparent h-[60px] rounded-full  mt-8 about8:mt-14 shadow-md shadow-gray-400 border  px-2 about8:px-5 py-2 about8:py-5">
...
<SelectItem value="Job ID (Ascending)">Job ID (Ascending)</SelectItem>
<SelectItem value="Job ID (Descending)">Job ID (Descending)</SelectItem>
<SelectItem value="Job Title (Ascending)">Job Title (Ascending)</SelectItem>
<SelectItem value="Job Title (Descending)">Job Title (Descending)</SelectItem>
<SelectItem value="Responsibilities (Ascending)">Responsibilities (Ascending)</SelectItem>
<SelectItem value="Responsibilities (Descending)">Responsibilities (Descending)</SelectItem>
...
//       {/* Replace this with the content you want to display on page 2 */}
//       <Pp />
//     </div>
//   );
...
//     <Wrapper>
//     <div>
//       <h2 className='sm:text-5xl/tight text-4xl/tight mt-10 font-bold text-gray-800 text-center gap-3'>Job Listings<span className='text-blue-600'> </span></h2>
//       <p className='text-center mt-1'>Our current job openings are listed on this page. Please click on the job title for more information, and apply from that page if you are interested.</p>
//       <p className='text-center mt-1'>Use this <span className='text-blue-600'>form</span> to perform another job search <span className='text-blue-600'>Start your job</span> search here</p>
//     </div>
//     <div className='flex gap-6'>
//       <div className='rounded-full border mt-14 shadow-md shadow-gray-400 w-[90%] px-5 py-5'><Input className="border-0 outline-none focus-visible:ring-0 focus-visible:ring-transparent" placeholder='Start your Job Search here'/></div>
//       <button className='sm:px-14 py-5 px-10 bg-blue-600 hover:bg-blue-500 hover:shadow-2xl mt-14 text-white rounded-full'>Search</button>
//     </div>
//     <div className='flex sm:gap-7 gap-2'>
//       {/* Select component 1 */}
//     </div>
//     <h2 className='text-gray-800 mt-8 px-1 text-xl'>Search Results Page {currentPage} of 2</h2>
//     <div className='flex justify-end'>
